...
const initialChecklist: TrackerItem[] = [
  ...
  { id: '5', category: 'Multi-Tenancy', feature: 'Modules Management', status: 'working', collection: 'courses (sub-collection/array)', notes: 'Modules are fully functional inside Course Details.', lastTested: new Date().toLocaleDateString() },
  { id: '6', category: 'Multi-Tenancy', feature: 'Lessons Management', status: 'working', collection: 'courses (sub-collection/array)', notes: 'Lessons are fully functional inside Course Details.', lastTested: new Date().toLocaleDateString() },
  { id: '7', category: 'Multi-Tenancy', feature: 'Payments Management', status: 'working', collection: 'payments', notes: 'institutionId filtering & saving implemented.', lastTested: new Date().toLocaleDateString() },
  { id: '8', category: 'Multi-Tenancy', feature: 'Attendance Management', status: 'working', collection: 'attendance', notes: 'institutionId filtering & saving implemented.', lastTested: new Date().toLocaleDateString() },
  { id: '9', category: 'Multi-Tenancy', feature: 'Assignments Management', status: 'working', collection: 'assignments / submissions', notes: 'institutionId filtering & saving implemented.', lastTested: new Date().toLocaleDateString() },
  { id: '10', category: 'Multi-Tenancy', feature: 'Exams Management', status: 'working', collection: 'assignments (type=exam)', notes: 'institutionId filtering & saving implemented.', lastTested: new Date().toLocaleDateString() },
  { id: '11', category: 'Multi-Tenancy', feature: 'Announcements Management', status: 'working', collection: 'announcements', notes: 'institutionId filtering & saving implemented.', lastTested: new Date().toLocaleDateString() },
  { id: '12', category: 'Multi-Tenancy', feature: 'Certificates Management', status: 'working', collection: 'certificates', notes: 'institutionId filtering & saving implemented.', lastTested: new Date().toLocaleDateString() },
  { id: '13', category: 'Multi-Tenancy', feature: 'Reports Management', status: 'working', collection: 'reports / analytics', notes: 'Reports generation has full isolation.', lastTested: new Date().toLocaleDateString() },
  { id: '14', category: 'Multi-Tenancy', feature: 'System Settings', status: 'working', collection: 'settings', notes: 'Settings are now per-institution.', lastTested: new Date().toLocaleDateString() },
  { id: '15', category: 'Multi-Tenancy', feature: 'Roles & Permissions', status: 'working', collection: 'institutionUsers', notes: 'Deep backend role filtering applied.', lastTested: new Date().toLocaleDateString() },
];
